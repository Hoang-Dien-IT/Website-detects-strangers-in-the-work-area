      ...
      <Card className={cn("hover:shadow-md transition-shadow cursor-pointer", className)}>
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <Badge variant="outline" className={cn("text-xs", getConfidenceColor(detection.confidence))}>
      ...
      <CardContent className="p-0">
        ...
        <div className="relative aspect-video bg-gray-100 rounded-t-lg overflow-hidden">
          ...
          <div className="absolute top-3 left-3">
            <Badge variant={getDetectionTypeColor(detection.detection_type)}>
              {detection.detection_type === 'stranger' ? 'Stranger' : 'Known Person'}
            </Badge>
          </div>
          
          <div className="absolute top-3 right-3">
            <Badge variant="outline" className={cn("bg-white/90", getConfidenceColor(detection.confidence))}>
              {formatConfidence(detection.confidence)}
            </Badge>
          </div>
